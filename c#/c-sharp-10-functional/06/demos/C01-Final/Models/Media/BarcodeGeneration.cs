...
public static class BarcodeGeneration
{
    ...
    private static SKPaint ThickBar(Style style) => Bar(SKColors.Black, style.ThickBarWidth, style.Antialias);
    private static SKPaint ThinBar(Style style) => Bar(SKColors.Black, style.ThinBarWidth, style.Antialias);
    private static SKPaint Gap(Style style) => Bar(SKColors.Transparent, style.GapWidth, style.Antialias);
